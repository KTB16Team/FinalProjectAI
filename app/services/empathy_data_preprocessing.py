...
def main():
    ...
    print(f"Train set size: {len(train_dataset_augmented)}")
    ...
    for epoch in range(num_epochs):
        avg_loss, epoch_losses = train_model(model, train_loader_augmented, optimizer, criterion, device, max_grad_norm=1.0)
